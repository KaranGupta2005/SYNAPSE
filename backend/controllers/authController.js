...
export const login = async (req, res) => {
  ...
  // keep only last 4 refresh tokens, add new one (total 5)
...
// Mark user as onboarded after completing questionnaire
export const completeOnboarding = async (req, res) => {
  ...
  if (user.isOnboarded) {
    throw new ExpressError(400, "User already onboarded");
  }
